                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="postal_code" type="text" data-mask="00.000-000" class="form-control @error('postal_code') is-invalid @enderror" value="{{ old('postal_code') }}" name="postal_code" required autocomplete="postal_code">
                            ...
                            <div class="row mb-3">
                                <label for="address_number" class="col-md-4 col-form-label text-md-end">{{ __('Número') }}</label>

                                <div class="col-md-6">
                                    <input id="address_number" type="text" class="form-control @error('address_number') is-invalid @enderror" value="{{ old('address_number') }}" name="address_number" required autocomplete="address_number">
                            ...
                            <div class="row mb-3">
                                <label for="phone" class="col-md-4 col-form-label text-md-end">{{ __('Fone') }}</label>
